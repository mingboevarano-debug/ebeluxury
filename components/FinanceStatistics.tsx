...
export default function FinanceStatistics({ profits, expenses }: FinanceStatisticsProps) {
    ...
    const stats = useMemo(() => {
        ...
        profits.forEach(p => {
            profitByCategory[p.categoryName] = (profitByCategory[p.categoryName] || 0) + p.amount;
        });
        ...
        profits.forEach(p => {
            ...
            monthlyStats[key].profit += p.amount;
        });
        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">{t('finance.profit')}</p>
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">{t('finance.total')}</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">{t('finance.expense')}</p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-center space-x-2 mb-6 border-b pb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-800">{t('finance.stats.financial_overview') || 'Financial Overview'}</h3>
                </div>
                <div className="h-80 w-full flex items-center justify-center">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            <Pie
                                data={[
                                    { name: t('finance.tab.profit'), value: stats.totalProfit },
                                    { name: t('finance.tab.expense'), value: stats.totalExpense }
                                ]}
                                cx="50%"
                                cy="50%"
                                innerRadius={80}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                    <div className="flex items-center space-x-2 mb-6 border-b pb-4">
                        ...
                        <h3 className="text-lg font-bold text-gray-800">{t('finance.tab.profit')}</h3>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                    <div className="flex items-center space-x-2 mb-6 border-b pb-4">
                        ...
                        <h3 className="text-lg font-bold text-gray-800">{t('finance.tab.expense')}</h3>
                    </div>
                    <div className="h-80 w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
